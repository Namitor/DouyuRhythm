...
def start_crawl_room_list(room_urls):
    ...
    for room_url in room_urls:
        ...
        crawler_task = CrawlerThread(room_url)
        # crawler_task.run()
...
if __name__ == '__main__':
    room_url_list = ['http://www.douyutv.com/16789',
                     'http://www.douyutv.com/67373',
                     'http://www.douyutv.com/pis']
    start_crawl_room_list(room_url_list)

    time.sleep(5)
    task_dict['http://www.douyutv.com/16789'].stop()
    time.sleep(5)
    task_dict['http://www.douyutv.com/67373'].stop()
    time.sleep(5)
